...
func GenerateServices(grammr grammar.Grammar, packageName string) string {
	...
	node.Indent(func(n codegen.Node) {
		...
		n.AppendLine("    service.Put[parser.ErrorRecoveryStrategy](sc, parser.DefaultErrorRecovery{})")
		n.AppendLine("}")
		n.AppendLine("if !service.Has[parser.ErrorMessageProvider](sc) {")
		n.AppendLine("    service.Put[parser.ErrorMessageProvider](sc, parser.DefaultErrorMessageProvider{})")
		n.AppendLine("}")
