...
func generateScopeProvider(context *LinkerGeneratorContext) codegen.Node {
...
func generateLinker(context *LinkerGeneratorContext) codegen.Node {
	node := codegen.NewNode()
...
func generateSymbolContainers(context *LinkerGeneratorContext) codegen.Node {
...
func generateReferenceConstructor(context *LinkerGeneratorContext) codegen.Node {
	node := codegen.NewNode()
