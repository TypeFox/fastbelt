...
func getTypeName(fieldType grammar.FieldType) string {
...
func getAllExtends(grammr grammar.Grammar, iface grammar.Interface) []string {
	result := []string{}
	return llExtends(grammr, iface, result)
}
