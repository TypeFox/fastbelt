...
func NewPlusBlockStartStateData(atn *ATN, production *generated.Element, rule *generated.ParserRule, stateNumber int, decision int, end *BlockEndState, loopback PlusLoopbackState) *PlusBlockStartStateData {
